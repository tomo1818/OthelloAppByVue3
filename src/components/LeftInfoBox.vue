<template>
  <div class="infoBox">
    ...
    <div class="commandContainer">
      <div v-if="infoBox.mode == 'vsPlayer'" class="commandItem display mr10">
        <img
      ...
      <div class="commandItem display">
        <div v-if="turn == 1">
          <img src="@/assets/othelloPage/blackStone.png" alt="黒石のアイコン" />
        </div>
        <div v-else>
          <img src="@/assets/othelloPage/whiteStone.png" alt="白石のアイコン" />
        </div>
        <p>手番</p>
      </div>
    </div>
